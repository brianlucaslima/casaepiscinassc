                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                @if($categoria->subcategorias->count()>0)
                                  ...
                                  @foreach ($categoria->subcategorias as $categoria_pai)
                                    <ul class="dropdown-menu">
                                        <li><a href="#">{{ $categoria_pai->nome }}</a></li>
                                    </ul>
                                  @endforeach
                                </li>
                              @else
                              ...
                              @endforeach
                                <li class="dropdown-submenu">
                                    <a href="#" data-toggle="dropdown">Aquecimento<span class="ecaret"></span></a>
                                    <ul class="dropdown-menu">
                                      <li><a href="#">Solar</a></li>
                                      <li><a href="#">Trocador Calor</a></li>
                                    </ul>
                                </li>
                                <li><a href="#">Banheiras e Spas</a></li>
                                <li><a href="#">Aquecedores de Piscinas</a></li>
                                <li><a href="#">Iluminação e Cascatas</a></li>
                                <li><a href="#">Móveis e Acessórios</a></li>
                            </ul>
                        </li>
...
<div class="block bottom-sm-margin" >
    <div class="container">
        ...
        <p class="text-center font18">Somos uma empresa a <b>35 anos especializada</b> em <b>construção de piscinas
           de alto padrão.</b> Possuímos em nosso portifólio +250 piscinas projetadas e construidas.
            equipe técnica especializada para melhor te atender.

            <br>
            <br>

            <a href="/queSomos" class="text-center">Ver mais</a>
            </p>
            <!--
   Atendemos os estados de Santa Catarina e Paraná entregamos e instalamos sua piscina em fibra
         em qualquer tamanho em até 72 horas.
        Representamos e Distribuímos as melhores marcas de: equipamentos, filtros, acessórios de limpeza,
                ...
                <div class="inside">
                    ...
                    <div class="price-carousel">
                        <div class="price-item">
                            <h6 class="price-title text-center">MANUTENÇÃO DE PISCINAS</h6>
                            <br />
                            <br />
                            <div class="price-action"><a href="#modalForm1" class="btn btn-orange modal-popup-link">SOLICITE UM ORÇAMENTO</a></div>
                        </div>
                        <div class="price-item">
                            <h6 class="price-title text-center">PISCINAS DE VINIL</h6>
                            <br />
                            <br />
                            <div class="price-action"><a href="#modalForm1" class="btn btn-orange modal-popup-link">SOLICITE UM ORÇAMENTO</a></div>
                        </div>
                        <div class="price-item">
                            <h6 class="price-title text-center">PISCINAS DE FIBRA</h6>
                            <br />
                            <br />
                            <div class="price-action"><a href="#modalForm1" class="btn btn-orange modal-popup-link">SOLICITE UM ORÇAMENTO</a></div>
                        </div>
                        <div class="price-item">
                            <h6 class="price-title text-center">PISCINAS DE ALVENARIA</h6>
                            <br />
                            <br />
                            <div class="price-action"><a href="#modalForm1" class="btn btn-orange modal-popup-link">SOLICITE UM ORÇAMENTO</a></div>
                        </div>
                        <div class="price-item">
                            <h6 class="price-title text-center">SPAS</h6>
                            <br />
                            <br />
                            <div class="price-action"><a href="#modalForm1" class="btn btn-orange modal-popup-link">SOLICITE UM ORÇAMENTO</a></div>
                        </div>
                        <div class="price-item">
                            <h6 class="price-title text-center">BANHEIRAS</h6>
                            <br />
                            <br />
                            <div class="price-action"><a href="#modalForm1" class="btn btn-orange modal-popup-link">SOLICITE UM ORÇAMENTO</a></div>
                        </div>
                        <div class="price-item">
                            <h6 class="price-title text-center">AQUECIMENTO DE PISCINAS</h6>
                            <br />
                            <br />
                            <div class="price-action"><a href="#modalForm1" class="btn btn-orange modal-popup-link">SOLICITE UM ORÇAMENTO</a></div>
                        </div>
      ...
      <h2 class="decor color text-center">NOSSOS SERVIÇOS</h2>
        <div class="row category-carousel">
            <div class="col-sm-6 col-md-4">
                <a href="/Home/Suporte" class="category-item animation" data-animation="fadeInLeft" data-animation-delay="0s">
                    <div class="category-image">
                        <img src="/images/category-img-01.jpg" alt="" class="img-responsive">
                        <h5 class="category-title">DESIGN E PROJETOS RESIDENCIAIS E COLETIVAS</h5>
                        <div class="wave-wrapper">
                            <div class="wave"></div>
                        </div>
                    </div>
                    <div class="category-text">
                        Nós encontramos a superfície ideal para sua piscina com design perfeito para valorização do seu espaço.<span class="category-more-link">
            ...
            <div class="col-sm-6 col-md-4">
                <a href="/Home/Suporte" class="category-item animation" data-animation="fadeInLeft" data-animation-delay="0s">
                    <div class="category-image">
                        <img src="/images/category-img-02.jpg" alt="" class="img-responsive">
                        <h5 class="category-title">
                          INSTALAÇÃO DE PISCINAS EM ATÉ 72h </h5>
                        <div class="wave-wrapper">
                            <div class="wave"></div>
                        </div>
                    </div>
                    <div class="category-text">
                        Nós garantimos a instalação de fibra sua piscina em até 72h.
                            <span class="icon icon-right-arrow"></span>
                        </span>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4">
                <a href="/Home/Suporte" class="category-item animation" data-animation="fadeIn" data-animation-delay="0s">
                    <div class="category-image">
                        <img src="/images/category-img-03.jpg" alt="" class="img-responsive">
                        <h5 class="category-title">
                    ...
                    <div class="category-text">
                        Possuímos uma equipe especializada para manter sua piscina limpa, conservada e própria para uso.<span class="category-more-link">
                            <span class="icon icon-right-arrow"></span>
                        </span>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4">
                <a href="/Home/Suporte" class="category-item animation" data-animation="fadeInLeft" data-animation-delay="0s">
                    <div class="category-image">
                        <img src="/images/category-img-01.jpg" alt="" class="img-responsive">
                        <h5 class="category-title">TROCA DE AREIA E MANUTENÇÃO DE FILTROS
                    ...
                    <div class="category-text">
                        Possuímos mão de obra própria especializada com funcionários registrados.<span class="category-more-link">
                            <span class="icon icon-right-arrow"></span>
                        </span>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4">
                <a href="/Home/Suporte" class="category-item animation" data-animation="fadeInLeft" data-animation-delay="0s">
                    <div class="category-image">
                        <img src="/images/category-img-02.jpg" alt="" class="img-responsive">
                        <h5 class="category-title">
                            INSTALAÇÃO DE BOTOEIRA, ROLO ANTI-SUCÇÃO E AQUECEDOR
                        </h5>
                        <div class="wave-wrapper">
                            <div class="wave"></div>
                        </div>
            ...
            <div class="col-sm-6 col-md-4">
                <a href="/Home/Suporte" class="category-item animation" data-animation="fadeIn" data-animation-delay="0s">
                    <div class="category-image">
                        <img src="/images/limp-e-manu.png" alt="" class="img-responsive">
                        <h5 class="category-title">LIMPEZA E MANUTENÇÃO</h5>
                        <div class="wave-wrapper">
                            <div class="wave"></div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="footer-menu hidden-sm hidden-xs">
                <ul>
                    ...
                    <li><a href="/Home/QuemSomos">Produtos</a></li>
                    <li><a href="/Home/Suporte">Serviços</a></li>
                    <li><a href="/Home/Portfolio">Galeria</a></li>
            ...
            <div class="row footer-row">
                <div class="col-sm-4">
                    <ul class="contact-list">
                        <li>
                            <span class="oi oi-map-marker" style="color:white;"> </span>   Barra do Arririu, Palhoça - SC
                        </li>
