...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Cadastrar Fotos Galeria</h1>
</div>
<!-- É daqui pra frente -->
@if (count($errors) > 0)
...
<form method="POST" action="{{ action('GaleriaController@store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <label for="dirFotoGaleria">Foto das Imagens</label>
    <input type="file" class="form-control-file" name="dirFotoGaleria">
